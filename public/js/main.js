(function ($) {
  ...
  const scrollTopPercentage = () => {
    const scrollPercentage = () => {
      ...
      scrollElementWrap.css(
        "background",
        `conic-gradient( var(--rr-theme-primary) ${scrollValue}%, var(--rr-color-900) ${scrollValue}%)`
      );
  ...
  $("#pricing-appointment__form").submit(function (event) {
    ...
    setTimeout(function () {
      $.ajax({
        ...
        .done(function (data) {
          $(".loading-form").hide();
          $(".pricing-appointment__form").append(
  ...
  $(
    ".take-appointment-3__form-input-select select, .take-appointment__form-input-select select, .doctor-details__form-input-select select, .appointment-2__form-input-select select, .pricing-appointment__form-select select"
  ).niceSelect();
